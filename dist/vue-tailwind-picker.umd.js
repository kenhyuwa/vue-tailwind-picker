(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('dayjs'), require('dayjs/plugin/isToday'), require('dayjs/plugin/customParseFormat'), require('dayjs/plugin/isBetween'), require('dayjs/plugin/localizedFormat'), require('dayjs/plugin/advancedFormat')) :
  typeof define === 'function' && define.amd ? define(['exports', 'dayjs', 'dayjs/plugin/isToday', 'dayjs/plugin/customParseFormat', 'dayjs/plugin/isBetween', 'dayjs/plugin/localizedFormat', 'dayjs/plugin/advancedFormat'], factory) :
  (global = global || self, factory(global.VueTailwindPicker = {}, global.dayjs, global['dayjs/plugin/isToday'], global['dayjs/plugin/customParseFormat'], global['dayjs/plugin/isBetween'], global['dayjs/plugin/localizedFormat'], global['dayjs/plugin/advancedFormat']));
}(this, (function (exports, dayjs, isToday, customParseFormat, isBetween, localizedFormat, advancedFormat) { 'use strict';
