;(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : ((global = global || self),
      factory(
        (global.VueTailwindPicker = {}),
        global.dayjs,
        global['dayjs/plugin/isToday'],
        global['dayjs/plugin/customParseFormat'],
        global['dayjs/plugin/isBetween'],
        global['dayjs/plugin/localizedFormat'],
        global['dayjs/plugin/advancedFormat'],
      ))
})(this, function(exports, dayjs, isToday, customParseFormat, isBetween, localizedFormat, advancedFormat) {
  'use strict'
  ...
  customParseFormat =
    customParseFormat && Object.prototype.hasOwnProperty.call(customParseFormat, 'default')
      ? customParseFormat['default']
      : customParseFormat
  isBetween = isBetween && Object.prototype.hasOwnProperty.call(isBetween, 'default') ? isBetween['default'] : isBetween
  localizedFormat =
    localizedFormat && Object.prototype.hasOwnProperty.call(localizedFormat, 'default')
      ? localizedFormat['default']
      : localizedFormat
  advancedFormat =
    advancedFormat && Object.prototype.hasOwnProperty.call(advancedFormat, 'default')
      ? advancedFormat['default']
      : advancedFormat
  ...
  var __vue_render__ = function() {
    ...
    return _c('div', { staticClass: 'relative select-none', class: _vm.className.textColor }, [
      _c(
        'div',
        [
          _vm._t('default'),
          ...
          _c('transition', { attrs: { name: 'v-tailwind-picker' } }, [
            _c(
              'div',
              {
                staticClass: 'absolute bottom-0 inset-x-0 bg-transparent mt-3 z-10',
                  ...
                  [
                    _c('div', { attrs: { id: 'v-tailwind-picker-header' } }, [
                      _c(
                        'div',
                        {
                          staticClass: 'flex flex-row justify-center items-center p-3',
                        },
                        [
                          _c(
                            'div',
                            {
                              staticClass: 'flex items-center font-semibold text-2xl xl:text-3xl leading-none',
                            },
                    ...
                    _vm._v(' '),
                    _c('div', { staticClass: 'relative px-1 py-2' }, [
                      _c('div', {
                      ...
                      _c(
                        'div',
                        {
                          staticClass: 'flex justify-between items-center relative',
                        },
                        [
                          _c(
                            'div',
                                    ...
                                    ? _c(
                                        ...
                                        [
                                          _c(
                                            'div',
                                            {
                                              staticClass: 'transition duration-150 ease-out p-2',
                                              class: [
                                                _vm.visiblePrev ? 'cursor-pointer' : 'cursor-not-allowed opacity-30',
                                                _vm.className.pagination.textColor,
                                            ...
                                            [
                                              _c(
                                                'svg',
                                                {
                                                  staticClass: 'h-4 w-auto fill-current',
                                                  attrs: {
                          ...
                          _c(
                            ...
                            [
                              _c(
                                ...
                                {
                                  staticClass:
                                    'flex-1 rounded overflow-hidden py-1 ml-2 mr-1 font-semibold text-center cursor-pointer transition duration-150 ease-out',
                                  class: 'hover:' + _vm.className.pagination.hover,
                                  on: {
                                    click: function($event) {
                              ...
                              _c(
                                ...
                                {
                                  staticClass:
                                    'flex-1 rounded overflow-hidden py-1 mr-2 ml-1 font-semibold text-center cursor-pointer transition duration-150 ease-out',
                                  class: 'hover:' + _vm.className.pagination.hover,
                                  on: {
                                    click: function($event) {
                                        ...
                                        [
                                          _c(
                                            'div',
                                            {
                                              staticClass: 'transition duration-150 ease-out p-2',
                                              class: [
                                                _vm.visibleNext ? 'cursor-pointer' : 'cursor-not-allowed opacity-30',
                                                _vm.className.pagination.textColor,
                                                'hover:' + _vm.className.pagination.hover,
                                              ],
                                              on: {
                    ...
                    _c(
                      'div',
                      {
                        staticClass: 'smooth-scrolling overflow-x-hidden overflow-y-auto',
                      },
                      [
                        _c('transition', { attrs: { name: 'v-tailwind-picker-body' } }, [
                          !_vm.enableMonth && !_vm.enableYear
                            ? _c('div', { staticClass: 'relative' }, [
                                _c(
                                  'div',
                                  {
                                    staticClass: 'flex flex-no-wrap py-1 border-b',
                                  ...
                                  _vm._l(_vm.days, function(day, i) {
                                    return _c(
                                      ...
                                      {
                                        key: day,
                                        staticClass: 'w-1/7 flex justify-center',
                                      },
                                      [
                                        _c(
                                          'div',
                                ...
                                _c(
                                  ...
                                  [
                                    _vm._l(_vm.previousPicker, function(date, i) {
                                      return _c(
                                        'div',
                                        {
                                          key: '' + date.$D + date.$M + date.$y + '-previous',
                                          staticClass: 'w-1/7 flex justify-center cursor-not-allowed bg-gray-200 my-px',
                                          class: {
                                            'rounded-r-full': i === _vm.previousPicker.length - 1,
                                          },
                                        },
                                        [
                                          _c(
                                            'div',
                                            {
                                              staticClass: 'relative h-8 w-8 flex justify-center items-center',
                                            },
                                            [
                                              _c(
                                                'div',
                                                ...
                                                [
                                                  _c(
                                                    'div',
                                                    {
                                                      staticClass: 'text-xs opacity-50',
                                                      class: [
                                                        _vm.classicTheme
                                                          ? date.day() === 0
                                                            ? 'text-red-500'
                                    ...
                                    _vm._l(_vm.currentPicker, function(date) {
                                      ...
                                      return _c(
                                        'div',
                                        {
                                          ...
                                          staticClass: 'w-1/7 group flex justify-center items-center my-px py-px',
                                        },
                                        [
                                          _c('div', { staticClass: 'relative' }, [
                                            date.$events
                                              ? _c('div', {
                                                  staticClass: 'absolute top-0 right-0 h-2 w-2 rounded-full z-10',
                                                  class: [
                                                    {
                                                      'bg-indigo-500': !date.$events.color,
                                                    },
                                                  ],
                                                  style: {
                                              ...
                                              [
                                                _vm.possibleDate(date)
                                                  ? _c('div', {
                                                      ...
                                                      class: [
                                                        {
                                                          border: date.$D !== _vm.today.$D,
                                                        },
                                                        date.$D === _vm.today.$D
                                                          ? _vm.className.calendar.selected.backgroundColor
                                                          : 'cursor-pointer',
                                                        'hover:' + _vm.className.calendar.selected.borderColor,
                                                      ],
                                                      on: {
                                                        click: function($event) {
                                                          return _vm.changePicker(date)
                                                        },
                                                      },
                                                    })
                                                  : _vm._e(),
                                                    ...
                                                    _c(
                                                      'div',
                                                      {
                                                        class: [
                                                          {
                                                            'text-red-500':
                                                              (_vm.holidayDate(date) || date.day() === 0) &&
                                                              date.$D !== _vm.today.$D &&
                                                              _vm.classicTheme,
                                                          },
                                                          {
                                                          ...
                                                          (_obj[
                                                            'z-10 ' +
                                                              _vm.className.calendar.selected.textColor +
                                                              ' font-semibold'
                                                          ] = date.$D === _vm.today.$D),
                                                          _obj),
                                                          {
                                                            'opacity-50 cursor-not-allowed': !_vm.possibleDate(date),
                                                          },
                                                        ],
                                                      },
                                                      [_c('span', [_vm._v(_vm._s(date.$D))])],
                                                    ),
                                                  ],
                                                ),
                                              ],
                          ...
                          [
                            _vm.enableMonth
                              ? _c(
                                  'div',
                                  {
                                    staticClass: 'relative smooth-scrolling overflow-y-auto overflow-x-hidden',
                                  },
                                  [
                                    _c(
                                      'div',
                                      ...
                                      _vm._l(_vm.months, function(month, i) {
                                        return _c(
                                          ...
                                          {
                                            key: i,
                                            staticClass: 'w-1/3 flex justify-center items-center px-2',
                                          },
                                          [
                                            _c(
                                              'div',
                                              {
                                                ...
                                                class: [
                                                  i === _vm.today.$M
                                                    ? _vm.className.monthAndYear.borderColor
                                                    : _vm.className.borderColor,
                                                  'hover:' + _vm.className.monthAndYear.borderColor,
                                                ],
                                                on: {
                                                  click: function($event) {
                              ...
                              ? _c(
                                  ...
                                  [
                                    _c(
                                      'transition-group',
                                      {
                                        staticClass: 'flex flex-wrap border-t px-2 py-1',
                                        class: _vm.className.borderColor,
                                        attrs: {
                                              ...
                                              _c(
                                                ...
                                                [
                                                  _c('div', { staticClass: 'text-xs' }, [
                                                    _vm._v(_vm._s(_vm.dayjs(event.$events.date, _vm.formatDate).$D)),
                                                  ]),
                                                ],
                                              ),
                                              _vm._v(' '),
                                              _c('div', { staticClass: 'text-xs mx-1' }, [
  ...
  var __vue_inject_styles__ = function(inject) {
    ...
    inject('data-v-1a904680_0', {
      source:
        "\n#v-tailwind-picker[data-v-1a904680] {\n  top: 95%;\n}\n#v-tailwind-picker[data-v-1a904680]:not(.inline-mode)::before {\n  content: '';\n  width: 14px;\n  height: 14px;\n  z-index: 10;\n  top: -7px;\n  left: 12px;\n  border-radius: 2px;\n  display: block;\n  position: absolute;\n  background: #ffffff;\n  border-top: 1px solid #e2e8f0;\n  border-left: 1px solid #e2e8f0;\n  transform: rotate(45deg);\n}\n#v-tailwind-picker .smooth-scrolling[data-v-1a904680] {\n  height: 248px;\n  max-height: 250px;\n}\n.w-1\\/7[data-v-1a904680] {\n  width: 14.285714%;\n}\n.v-tailwind-picker-enter-active[data-v-1a904680],\n.v-tailwind-picker-leave-active[data-v-1a904680] {\n  transition: all 0.1s;\n}\n.v-tailwind-picker-enter[data-v-1a904680],\n.v-tailwind-picker-leave-to[data-v-1a904680] {\n  opacity: 0;\n  transform: translateY(15px);\n}\n.v-tailwind-picker-chevron-left-enter-active[data-v-1a904680],\n.v-tailwind-picker-chevron-left-leave-active[data-v-1a904680] {\n  transition: all 0.2s;\n}\n.v-tailwind-picker-chevron-left-enter[data-v-1a904680],\n.v-tailwind-picker-chevron-left-leave-to[data-v-1a904680] {\n  opacity: 0;\n  transform: translateX(-15px);\n}\n.v-tailwind-picker-chevron-right-enter-active[data-v-1a904680],\n.v-tailwind-picker-chevron-right-leave-active[data-v-1a904680] {\n  transition: all 0.2s;\n}\n.v-tailwind-picker-chevron-right-enter[data-v-1a904680],\n.v-tailwind-picker-chevron-right-leave-to[data-v-1a904680] {\n  opacity: 0;\n  transform: translateX(15px);\n}\n.v-tailwind-picker-body-enter-active[data-v-1a904680],\n.v-tailwind-picker-body-leave-active[data-v-1a904680] {\n  transition: all 0.2s;\n}\n.v-tailwind-picker-body-enter[data-v-1a904680],\n.v-tailwind-picker-body-leave-to[data-v-1a904680] {\n  opacity: 0;\n  transform: translateY(-15px);\n}\n.v-tailwind-picker-footer-enter-active[data-v-1a904680],\n.v-tailwind-picker-footer-leave-active[data-v-1a904680] {\n  transition: all 0.2s;\n}\n.v-tailwind-picker-footer-enter[data-v-1a904680],\n.v-tailwind-picker-footer-leave-to[data-v-1a904680] {\n  opacity: 0;\n  transform: translateY(-15px);\n}\n.v-tailwind-picker-months-and-year-enter-active[data-v-1a904680],\n.v-tailwind-picker-months-and-year-leave-active[data-v-1a904680] {\n  transition: all 0.2s;\n}\n.v-tailwind-picker-months-and-year-enter[data-v-1a904680],\n.v-tailwind-picker-months-and-year-leave-to[data-v-1a904680] {\n  opacity: 0;\n  transform: translateY(-15px);\n}\n",
      map: {
        version: 3,
        sources: [
        ...
        names: [],
        mappings:
          ';AAqgBA;EACA,QAAA;AACA;AAEA;EACA,WAAA;EACA,WAAA;EACA,YAAA;EACA,WAAA;EACA,SAAA;EACA,UAAA;EACA,kBAAA;EACA,cAAA;EACA,kBAAA;EACA,mBAAA;EACA,6BAAA;EACA,8BAAA;EACA,wBAAA;AACA;AAEA;EACA,aAAA;EACA,iBAAA;AACA;AAEA;EACA,iBAAA;AACA;AAEA;;EAEA,oBAAA;AACA;AAEA;;EAEA,UAAA;EACA,2BAAA;AACA;AAEA;;EAEA,oBAAA;AACA;AAEA;;EAEA,UAAA;EACA,4BAAA;AACA;AAEA;;EAEA,oBAAA;AACA;AAEA;;EAEA,UAAA;EACA,2BAAA;AACA;AAEA;;EAEA,oBAAA;AACA;AAEA;;EAEA,UAAA;EACA,4BAAA;AACA;AAEA;;EAEA,oBAAA;AACA;AAEA;;EAEA,UAAA;EACA,4BAAA;AACA;AAEA;;EAEA,oBAAA;AACA;AAEA;;EAEA,UAAA;EACA,4BAAA;AACA',
  ...
  /* scoped */
  var __vue_scope_id__ = 'data-v-1a904680'
  /* module identifier */
